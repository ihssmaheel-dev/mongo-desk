...
<div class="flex h-8 items-center justify-between bg-[#023430] px-3" data-tauri-drag-region>
  <div class="flex items-center gap-2" data-tauri-drag-region>
    ...
    <span class="text-[12px] font-semibold text-white" data-tauri-drag-region>{title}</span>
  </div>
